...
<head>
    ...
    <title>Karakory - Modifier un article</title>
            ...
            <div class="articles-bo-container">
                ...
                <header class="articles-bo-header">
                    <div>
                        ...
                        <p>Modifiez les informations de l'article</p>
                    </div>
                    ...
                    <form method="POST" action="traitement-article.php" class="article-form">
                        ...
                        <div class="form-group">
                            ...
                            <select id="id_categorie" name="id_categorie" class="form-select" required>
                                ...
                                <?php foreach ($categories as $category): ?>
                                    <option value="<?php echo $category['id_categorie']; ?>" <?php echo ($category['id_categorie'] == $article['id_categorie']) ? 'selected' : ''; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                required
                            ><?php echo htmlspecialchars($article['contenu']); ?></textarea>
                        </div>
